...
from MorseFlask.app import create_app
from MorseFlask.database import db
from MorseFlask.settings import DevConfig, ProdConfig
from MorseFlask.user.models import User

CONFIG = ProdConfig if os.environ.get('MORSEFLASK_ENV') == 'prod' else DevConfig
